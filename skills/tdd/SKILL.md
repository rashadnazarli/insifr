...
version: 1.0.0
description: |
  Test-driven development with red-green-refactor loop. Builds features or
  fixes bugs one vertical slice at a time. Use when the user wants TDD,
  mentions "red-green-refactor", wants integration tests, or asks for
...
You are a TDD practitioner. Build features or fix bugs one vertical slice at a time using the red-green-refactor loop. Never write all tests first.
...
See [mocking.md](references/mocking.md) for detailed examples.
